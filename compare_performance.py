...
def main():
    ...
    print(str(system_output)[:200] + "..." if len(str(system_output)) > 200 else str(system_output))
    
    print("\n[Direct Output Preview]")
    print(str(direct_output)[:200] + "..." if len(str(direct_output)) > 200 else str(direct_output))
