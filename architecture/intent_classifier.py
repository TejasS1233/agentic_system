...
ALLOWED_DOMAINS = {
    ...
    "web": {
        ...
        "aliases": ["http", "api", "internet", "network", "scraping", "webapi", "rest", "websocket"],
...
def get_nlp():
    ...
    if _nlp is None:
        try:
            ...
            print("[IntentClassifier] spaCy model not found. Run: python -m spacy download en_core_web_sm")
            _nlp_failed = True
            return None
        except Exception as e:
            # Catch any import/compatibility errors (e.g., Python 3.14 incompatibility)
            print(f"[IntentClassifier] spaCy unavailable ({type(e).__name__}). Using fallback methods.")
            _nlp_failed = True
            return None
...
DOMAIN_KEYWORDS = {
    "math": {
        "calculate": 0.9, "compute": 0.9, "add": 0.8, "subtract": 0.8,
        "multiply": 0.9, "divide": 0.9, "sum": 0.5, "average": 0.8,
        "factorial": 0.95, "prime": 0.9, "sqrt": 0.9, "root": 0.7,
        "equation": 0.9, "formula": 0.8, "arithmetic": 0.9,
        "number": 0.6, "integer": 0.7, "float": 0.6, "decimal": 0.7,
        "even": 0.7, "odd": 0.7, "modulo": 0.9, "remainder": 0.8,
        "mean": 0.8, "median": 0.8, "mode": 0.7, "variance": 0.9,
        "deviation": 0.9, "logarithm": 0.95, "sin": 0.9, "cos": 0.9,
        "tan": 0.9, "matrix": 0.8, "vector": 0.8, "algebra": 0.9,
        "fibonacci": 0.95, "gcd": 0.95, "lcm": 0.95, "percentage": 0.8,
        "ratio": 0.8, "exponent": 0.9, "power": 0.7, "absolute": 0.7,
        "round": 0.6, "floor": 0.8, "ceiling": 0.8, "ceil": 0.8, "hypotenuse": 0.95
    },
    "text": {
        "string": 0.7, "text": 0.7, "word": 0.8, "sentence": 0.8,
        "parse": 0.5, "count": 0.4, "uppercase": 0.9, "lowercase": 0.9,
        "capitalize": 0.9, "replace": 0.6, "split": 0.6, "join": 0.6,
        "palindrome": 0.95, "reverse": 0.7, "trim": 0.8, "strip": 0.8,
        "anagram": 0.95, "token": 0.7, "tokenize": 0.9, "lemma": 0.9,
        "stem": 0.9, "grammar": 0.9, "spelling": 0.9, "punctuation": 0.8,
        "substring": 0.8, "regex": 0.8, "pattern": 0.6, "slug": 0.9,
        "camelcase": 0.9, "snakecase": 0.9, "alphanumeric": 0.7, "whitespace": 0.8,
        "concatenate": 0.8, "password": 0.6, "uuid": 0.6
    },
    "file": {
        "file": 0.8, "directory": 0.9, "folder": 0.9, "path": 0.8,
        "read": 0.6, "write": 0.6, "delete": 0.7, "create": 0.5,
        "list": 0.5, "copy": 0.7, "move": 0.7, "rename": 0.8,
        "sum": 0.3, "count": 0.4, "size": 0.7, "extension": 0.8,
        "backup": 0.8, "restore": 0.8, "sync": 0.7, "archive": 0.8,
        "zip": 0.9, "unzip": 0.9, "compress": 0.8, "extract": 0.7,
        "gzip": 0.95, "tar": 0.95, "merge": 0.7, "split": 0.6,
        "chmod": 0.95, "permissions": 0.8, "recursive": 0.7, "glob": 0.8
    },
    "web": {
        "url": 0.9, "http": 0.95, "https": 0.95, "api": 0.8,
        "request": 0.7, "response": 0.7, "get": 0.5, "post": 0.6,
        "fetch": 0.8, "download": 0.7, "upload": 0.7, "scrape": 0.9,
        "html": 0.8, "web": 0.8, "internet": 0.8, "website": 0.9,
        "ping": 0.8, "server": 0.6, "endpoint": 0.9, "webhook": 0.9,
        "crawler": 0.9, "spider": 0.9, "crawl": 0.9, "proxy": 0.8,
        "ssl": 0.8, "certificate": 0.7, "dns": 0.8, "cookie": 0.8,
        "session": 0.7, "redirect": 0.8, "online": 0.7, "offline": 0.6
    },
    "data": {
        "json": 0.8, "csv": 0.9, "xml": 0.8, "yaml": 0.8,
        "parse": 0.6, "convert": 0.5, "transform": 0.6, "serialize": 0.9,
        "deserialize": 0.9, "encode": 0.6, "decode": 0.6,
        "database": 0.9, "sql": 0.95, "query": 0.7, "table": 0.8,
        "record": 0.8, "row": 0.7, "column": 0.7, "field": 0.7,
        "dataframe": 0.95, "pandas": 0.95, "etl": 0.95, "pipeline": 0.7,
        "schema": 0.8, "nosql": 0.9, "mongodb": 0.95, "postgres": 0.95
    },
    "system": {
        "process": 0.8, "processes": 0.9, "command": 0.8, "execute": 0.8, "run": 0.5,
        "shell": 0.9, "terminal": 0.9, "subprocess": 0.95, "bash": 0.95, "zsh": 0.95,
        "environment": 0.8, "variable": 0.6, "env": 0.8, "path": 0.5,
        "daemon": 0.95, "service": 0.9, "services": 0.9, "cron": 0.95, "cronjob": 0.95,
        "cpu": 0.95, "memory": 0.9, "ram": 0.95, "disk": 0.7, "usage": 0.6,
        "thread": 0.8, "threads": 0.85, "spawn": 0.9, "fork": 0.9, "pid": 0.95,
        "kill": 0.9, "terminate": 0.9, "signal": 0.8, "stdin": 0.95, "stdout": 0.95,
        "stderr": 0.95, "pipe": 0.8, "systemd": 0.95, "launchd": 0.95,
        "uptime": 0.95, "hostname": 0.9, "reboot": 0.95, "shutdown": 0.95,
        "install": 0.7, "package": 0.6, "apt": 0.95, "brew": 0.95, "npm": 0.7
    },
    "visualization": {
        "plot": 0.95, "chart": 0.95, "graph": 0.8, "visualize": 0.95,
        "draw": 0.7, "render": 0.6, "display": 0.6, "show": 0.4,
        "bar": 0.7, "line": 0.5, "pie": 0.8, "histogram": 0.95, "diagram": 0.8,
        "picture": 0.7, "image": 0.5, "heatmap": 0.95, "scatter": 0.9,
        "treemap": 0.95, "sunburst": 0.95, "gauge": 0.9, "sparkline": 0.95,
        "figure": 0.8, "axes": 0.9, "legend": 0.8, "matplotlib": 0.95,
        "seaborn": 0.95, "plotly": 0.95, "canvas": 0.7, "dashboard": 0.8
    },
    "conversion": {
        "convert": 0.8, "conversion": 0.95, "transform": 0.7, "translate": 0.7,
        "celsius": 0.95, "fahrenheit": 0.95, "unit": 0.8, "units": 0.8,
        "pdf": 0.7, "docx": 0.7, "format": 0.5, "encode": 0.7, "decode": 0.7,
        "transcode": 0.95, "resize": 0.8, "timestamp": 0.8, "datetime": 0.7,
        "timezone": 0.9, "utc": 0.85, "ascii": 0.8, "unicode": 0.8, "utf8": 0.9,
        "jpg": 0.8, "jpeg": 0.8, "png": 0.8, "gif": 0.8, "webp": 0.8,
        "mp3": 0.8, "mp4": 0.8, "wav": 0.8, "avi": 0.8,
        "kg": 0.9, "lbs": 0.9, "pounds": 0.9, "kilograms": 0.9,
        "meters": 0.9, "feet": 0.9, "inches": 0.9, "miles": 0.9, "kilometers": 0.9,
        "liters": 0.9, "gallons": 0.9, "bytes": 0.7, "megabytes": 0.8, "gigabytes": 0.8,
        "base64": 0.95, "hex": 0.8, "binary": 0.7, "octal": 0.9, "rgb": 0.8
    },
    "validation": {
        "validate": 0.95, "validation": 0.95, "valid": 0.8, "invalid": 0.8,
        "verify": 0.8, "check": 0.5, "confirm": 0.7, "ensure": 0.7,
        "email": 0.8, "empty": 0.6, "null": 0.6, "required": 0.6, "assert": 0.8,
        "checksum": 0.95, "hash": 0.7, "md5": 0.95, "sha256": 0.95,
        "integrity": 0.9, "compliance": 0.9, "constraint": 0.8, "rules": 0.6,
        "ipv4": 0.95, "ipv6": 0.95, "guid": 0.9, "audit": 0.8
    },
    "search": {
        "search": 0.95, "find": 0.7, "lookup": 0.9, "query": 0.6,
        "retrieve": 0.8, "filter": 0.7, "match": 0.6, "locate": 0.9,
        "scan": 0.8, "browse": 0.85, "discover": 0.85, "explore": 0.8,
        "index": 0.8, "indexed": 0.85, "keyword": 0.8, "keywords": 0.85,
        "fulltext": 0.95, "fuzzy": 0.9, "catalog": 0.8, "results": 0.6, "hits": 0.7
    }
}
...
ENTITY_INDICATORS = {
    "math": {"number", "numbers", "integer", "integers", "float", "floats", "digit", "digits",
             "factorial", "prime", "even", "odd", "sum", "average", "arithmetic", "equation",
             "mean", "median", "mode", "variance", "deviation", "logarithm", "exponential",
             "sine", "cosine", "tangent", "matrix", "vector", "algebra", "calculus", "derivative",
             "integral", "fibonacci", "gcd", "lcm", "modulo", "remainder", "percentage", "ratio"},
    "file": {"file", "files", "directory", "directories", "folder", "folders", "path", "paths",
             "disk", "filesystem", "gzip", "zip", "compress", "archive", "merge", "backup",
             "tar", "untar", "extension", "filename", "chmod", "permissions"},
    "text": {"string", "strings", "word", "words", "text", "sentence", "character", "characters",
             "palindrome", "uppercase", "lowercase", "substring", "regex", "concatenate",
             "anagram", "token", "tokens", "paragraph", "grammar", "spelling", "punctuation",
             "alphanumeric", "whitespace", "newline", "camelcase", "snakecase", "slug"},
    "web": {"url", "urls", "website", "websites", "api", "apis", "endpoint", "endpoints", 
             "web", "internet", "http", "https", "download", "upload", "request", "response",
             "fetch", "scrape", "post", "get", "rest", "websocket", "socket", "server",
             "webpage", "html", "crawler", "spider", "proxy", "ssl", "certificate", "dns",
             "cookie", "cookies", "session", "header", "headers", "redirect", "online"},
    "data": {"json", "csv", "xml", "yaml", "data", "dataset", "database", "sql", 
             "serialize", "deserialize", "parse", "schema", "pandas", "dataframe", "read_csv",
             "record", "records", "row", "rows", "column", "columns", "table", "tables",
             "etl", "pipeline", "nosql", "mongodb", "postgres", "mysql", "sqlite"},
    "visualization": {"chart", "charts", "plot", "plots", "graph", "graphs", "histogram",
                      "bar", "pie", "line", "scatter", "visualization", "visualize", "diagram",
                      "heatmap", "treemap", "sunburst", "gauge", "sparkline", "canvas",
                      "figure", "axes", "legend", "matplotlib", "seaborn", "plotly"},
    "conversion": {"convert", "conversion", "transform", "celsius", "fahrenheit", "unit", "units",
                   "pdf", "docx", "format", "encode", "decode", "translate",
                   "kilometer", "kilometers", "mile", "miles", "hex", "decimal", "binary", "octal",
                   "base64", "rgb", "hexadecimal", "transcode", "resize", "timestamp", "datetime",
                   "timezone", "utc", "ascii", "unicode", "utf8", "encoding", "jpg", "jpeg", "png",
                   "gif", "mp3", "mp4", "wav", "avi", "mkv", "webp", "svg", "ico", "bmp",
                   "kg", "lbs", "pounds", "kilograms", "meters", "feet", "inches", "centimeters",
                   "liters", "gallons", "ounces", "grams", "bytes", "kilobytes", "megabytes", "gigabytes"},
    "validation": {"validate", "validation", "valid", "invalid", "email", 
                   "confirm", "ensure", "assert", "empty", "null", "required", "constraint",
                   "checksum", "hash", "md5", "sha256", "integrity", "compliance", "rules",
                   "alphanumeric", "numeric", "boolean", "ipv4", "ipv6", "uuid", "guid"},
    "search": {"lookup", "retrieve", "filter", "match", "search", "find", "locate", "scan",
               "index", "indexed", "keyword", "keywords", "fulltext", "fuzzy", "catalog",
               "browse", "discover", "explore", "results", "hits", "ranking"},
    "system": {"command", "shell", "terminal", "process", "processes", "environment", "os", "subprocess",
               "execute", "run", "script", "daemon", "service", "services", "cron", "cronjob",
               "cpu", "memory", "ram", "thread", "threads", "async", "spawn", "fork", "pid",
               "kill", "terminate", "signal", "stdin", "stdout", "stderr", "pipe", "bash", "zsh",
               "systemd", "launchd", "uptime", "hostname", "kernel", "reboot", "shutdown"},
}
...
PHRASE_PATTERNS = [
    ...
    (r'\bcheck\s+(if\s+)?(url|website|server)\s+(is\s+)?(reachable|online|up)\b', 'web'),
...
class IntentClassifier:
    ...
    def _train_tfidf_classifier(self):
        ...
        try:
            ...
            if len(set(domains)) < 2:
                print("[IntentClassifier] Not enough domain diversity for TF-IDF training")
                return
            ...
            print(f"[IntentClassifier] TF-IDF classifier trained on {len(texts)} samples, {len(set(domains))} domains")
    ...
    def _extract_verb_object(self, query: str) -> Tuple[Optional[str], Optional[str]]:
        ...
        try:
            ...
            COMMAND_VERBS = {"query", "scan", "list", "print", "show", 
                             "copy", "move", "run", "search", "find"}
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "-i":
        ...
        print("Run with -i flag for interactive mode: python3 intent_classifier.py -i\n")
