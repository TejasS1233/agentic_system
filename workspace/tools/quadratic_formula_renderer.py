...
class QuadraticFormulaRendererArgs(BaseModel):
    ...
    output_path: str = Field(..., description="Path to save the rendered equation image")
...
class QuadraticFormulaRenderer:
    ...
    def run(self, equation_input: str, equation_latex: str, output_path: str, dpi: int) -> str:
